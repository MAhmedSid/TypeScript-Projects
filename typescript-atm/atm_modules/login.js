...
async function login(current_balance) {
    console.log("\t Thankyou for using" + chalk.rgb(0, 255, 153)(" WAFADAAR Bank Ltd. ATM"));
    ...
    setTimeout(() => {
        console.log(chalk.rgb(0, 153, 255)(`You logged in Successfully! \n\nName:${user_data.user_id}\nAccount Number : usd${randomInteger(1000000000000, 1999999999999)}    \nCurrent Balance : ${current_balance}$`));
    }, 3000);
}
