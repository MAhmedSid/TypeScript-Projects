...
async function transactionTypeRecruiter(current_balance) {
    ...
    switch (required_tsc.tsc_type) {
        ...
        case "Balance Enquiry":
            ...
            await setTimeout(() => {
                chalk.rgb(51, 153, 51)(console.log(`Your current amount is ${current_balance}$`));
            }, 4000);
            setTimeout(() => {
            ...
            break;
        case "Exit":
            console.log(chalk.rgb(51, 153, 51)("Hope you have good experience with us"));
            break;
    }
}
